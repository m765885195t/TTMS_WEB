...
create table data_dict (
  ...
  dict_index     int           not null
  comment '字典的序号',
  dict_name      nvarchar(200) not null
  comment '字典名称',
...
create table user (
  ...
  user_update_time timestamp comment 'updateTime',
...
create table play (
  ...
  comment '剧目语言',
  play_name         nvarchar(200)  not null
  comment '剧目名称',
